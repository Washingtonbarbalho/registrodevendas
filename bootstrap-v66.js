import { applySetupPatches } from './app-patch-setup-v59.js?v=66';
import { applyReportsPatch } from './app-patch-reports-v65.js?v=66';
import { applyStockPatch } from './app-patch-stock-v52.js?v=66';
import { applyCancelPatch } from './app-patch-cancel-v59.js?v=66';
import { applyProfitPatch } from './app-patch-profit-v58.js?v=66';
import { applySalePdfPatch } from './app-patch-sale-pdf-v65.js?v=66';
import { applyMobileMenuPatch } from './app-patch-mobile-menu-v66.js?v=66';
import { applyFinalPatches } from './app-patch-final-v66.js?v=66';
...
const criticalModules = [
  ['Financeiro', './aba-financeiro-v54.js?v=66', 'AbaFinanceiro'],
  ['Relatórios', './aba-relatorios-v65.js?v=66', 'AbaRelatorios'],
  ['Movimentação de estoque', './stock-movement-modal-v52.js?v=66', 'StockMovementModal'],
  ['Vendas no caixa', './aba-vendas-caixa-v52.js?v=66', 'AbaVendasCaixa'],
  ['Vendas a prazo', './aba-vendas-prazo-v52.js?v=66', 'AbaVendasPrazo'],
  ['Clientes', './aba-clientes-fixed-v52.js?v=66', 'AbaClientes'],
  ['Modais', './modals-fixed-v65.js?v=66', 'SaleDetailsModal'],
  ['Nova venda', './nova-venda-fixed-v65.js?v=66', 'NewSaleScreen']
];
...
export const startApp = async () => {
  const cleanupKey = 'registro-vendas-cleanup-v66';
  ...
  try {
    ...
    await withStage('Falha ao restaurar a última aba', async () => import('./tab-persistence.js?v=66'));
  } finally {
