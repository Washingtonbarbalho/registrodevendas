import { applySetupPatches } from './app-patch-setup-v57.js?v=57';
import { applyStockPatch } from './app-patch-stock-v52.js?v=57';
import { applyCancelPatch } from './app-patch-cancel-v57.js?v=57';
import { applyFinalPatches } from './app-patch-final-v57.js?v=57';
...
const criticalModules = [
  ['Financeiro', './aba-financeiro-v54.js?v=57', 'AbaFinanceiro'],
  ['Movimentação de estoque', './stock-movement-modal-v52.js?v=57', 'StockMovementModal'],
  ['Cancelamento de venda', './sale-cancellation-modal-v57.js?v=57', 'SaleCancellationModal'],
  ['Vendas no caixa', './aba-vendas-caixa-v52.js?v=57', 'AbaVendasCaixa'],
  ['Vendas a prazo', './aba-vendas-prazo-v52.js?v=57', 'AbaVendasPrazo'],
  ['Clientes', './aba-clientes-fixed-v52.js?v=57', 'AbaClientes'],
  ['Modais', './modals-fixed-v52.js?v=57', 'SaleDetailsModal'],
  ['Nova venda', './nova-venda-fixed-v55.js?v=57', 'NewSaleScreen']
];
...
export const startApp = async () => {
  const cleanupKey = 'registro-vendas-cleanup-v57';
  ...
  try {
    ...
    await withStage('Falha ao restaurar a última aba', async () => import('./tab-persistence.js?v=57'));
  } finally {
