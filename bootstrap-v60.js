import { applySetupPatches } from './app-patch-setup-v59.js?v=60';
import { applyStockPatch } from './app-patch-stock-v52.js?v=60';
import { applyCancelPatch } from './app-patch-cancel-v59.js?v=60';
import { applyProfitPatch } from './app-patch-profit-v58.js?v=60';
import { applyFinalPatches } from './app-patch-final-v60.js?v=60';
...
const criticalModules = [
  ['Financeiro', './aba-financeiro-v54.js?v=60', 'AbaFinanceiro'],
  ['Movimentação de estoque', './stock-movement-modal-v52.js?v=60', 'StockMovementModal'],
  ['Vendas no caixa', './aba-vendas-caixa-v52.js?v=60', 'AbaVendasCaixa'],
  ['Vendas a prazo', './aba-vendas-prazo-v52.js?v=60', 'AbaVendasPrazo'],
  ['Clientes', './aba-clientes-fixed-v52.js?v=60', 'AbaClientes'],
  ['Modais', './modals-fixed-v59.js?v=60', 'SaleDetailsModal'],
  ['Nova venda', './nova-venda-fixed-v60.js?v=60', 'NewSaleScreen']
];
...
export const startApp = async () => {
  const cleanupKey = 'registro-vendas-cleanup-v60';
  ...
  try {
    ...
    await withStage('Falha ao restaurar a última aba', async () => import('./tab-persistence.js?v=60'));
  } finally {
