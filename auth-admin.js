...
import { db, auth, APP_ID, ADMIN_EMAIL } from './firebase-config.js?v=97';
import { collection, query, doc, getDoc, onSnapshot, serverTimestamp, writeBatch, deleteField } from './firestore-runtime-v94.js?v=97';
