...
assert.equal((productionSource.match(/\b(?:window\.)?alert\s*\(/g) || []).length, 69,
  'Os 69 avisos auditados precisam permanecer cobertos pelo interceptador profissional.');
...
console.log(`Interface v${version} validada: lançamento financeiro unificado, calendário único, 69 avisos e 30 seletores.`);
