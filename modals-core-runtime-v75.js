...
import { formatCurrency, parseMoney, maskMoney, maskPhone, applyPixMask, generatePixPayload, maskCpfCnpj, maskCep, formatDate, getBrazilDateString } from './utils.js?v=84';
import { MoneyInput } from './components.js?v=84';
import QRCode from 'https://esm.sh/qrcode@1.5.4';
import { getHistoryCashAmount } from './financial-core-v70.js?v=84';
