...
import { formatCurrency, analyzeCustomerCredit, maskMoney, parseMoney } from './utils.js?v=77';
import { Pagination, MoneyInput } from './components.js?v=77';
import { CustomerPurchaseHistoryModal } from './customer-history-runtime-v75.js?v=77';
import { db, auth, APP_ID } from './firebase-config.js?v=77';
