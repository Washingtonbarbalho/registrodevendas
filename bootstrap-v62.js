import { applySetupPatches } from './app-patch-setup-v59.js?v=62';
import { applyReportsPatch } from './app-patch-reports-v62.js?v=62';
import { applyStockPatch } from './app-patch-stock-v52.js?v=62';
import { applyCancelPatch } from './app-patch-cancel-v59.js?v=62';
import { applyProfitPatch } from './app-patch-profit-v58.js?v=62';
import { applyFinalPatches } from './app-patch-final-v62.js?v=62';
...
const criticalModules = [
  ['Financeiro', './aba-financeiro-v54.js?v=62', 'AbaFinanceiro'],
  ['Relatórios', './aba-relatorios-v62.js?v=62', 'AbaRelatorios'],
  ['Movimentação de estoque', './stock-movement-modal-v52.js?v=62', 'StockMovementModal'],
  ['Vendas no caixa', './aba-vendas-caixa-v52.js?v=62', 'AbaVendasCaixa'],
  ['Vendas a prazo', './aba-vendas-prazo-v52.js?v=62', 'AbaVendasPrazo'],
  ['Clientes', './aba-clientes-fixed-v52.js?v=62', 'AbaClientes'],
  ['Modais', './modals-fixed-v59.js?v=62', 'SaleDetailsModal'],
  ['Nova venda', './nova-venda-fixed-v60.js?v=62', 'NewSaleScreen']
];
...
export const startApp = async () => {
  const cleanupKey = 'registro-vendas-cleanup-v62';
  ...
  try {
    ...
    await withStage('Falha ao restaurar a última aba', async () => import('./tab-persistence.js?v=62'));
  } finally {
