// Aplicação consolidada v95 — código-fonte principal do sistema.
...
// Firebase
import { app, db, auth, APP_ID } from './firebase-config.js?v=95';
import { collection, onSnapshot, query, doc, getDoc, updateDoc, deleteDoc, addDoc, serverTimestamp, setDoc, runTransaction, writeBatch } from './firestore-runtime-v94.js?v=95';
import { onAuthStateChanged, signOut } from "https://www.gstatic.com/firebasejs/12.7.0/firebase-auth.js";

// Utils
import { getCurrentMonthStart, getCurrentMonthEnd, getBrazilDateString, addDays, formatCurrency, formatDate } from './utils.js?v=95';
import { aggregateSaleItems, buildSaleInventoryPlan } from './inventory-reliability-v69.js?v=95';
import { applyInstallmentPayment, buildFinancialLedger, fromCents, getHistoryCashAmount, getInstallmentFaceAmount, getRealizedSalesProfit, getSalesAccrualSummary, isTermSale, normalizeSaleMoney, reverseInstallmentPayment, sumMoney, summarizeFinancialLedger, toCents } from './financial-core-v70.js?v=95';
...
} from './modals-runtime-v75.js?v=95';
import { StockMovementModal } from './stock-movement-modal-v68.js?v=95';

// Telas Secundárias
import { AdminUsersPanel } from './auth-admin.js?v=95';
import { AuthScreen } from './auth-screen-v71.js?v=95';
import { NewSaleScreen } from './nova-venda-runtime-v75.js?v=95';

// Abas do Dashboard
import { AbaVisaoGeral } from './aba-visao-geral-fixed.js?v=95';
import { AbaVendas } from './aba-vendas-v71.js?v=95';
import { AbaProdutos } from './aba-produtos-v67.js?v=95';
import { AbaClientes } from './aba-clientes-runtime-v75.js?v=95';
import { AbaTaxas } from './aba-taxas.js?v=95';
import { AbaFinanceiro } from './aba-financeiro-v68.js?v=95';
import { BatchStockModal } from './batch-stock-modal-v68.js?v=95';
import { AbaRelatorios } from './aba-relatorios-v73.js?v=95';
import { AbaComercial } from './aba-comercial-v74.js?v=95';
import { normalizePaymentSettings } from './payment-settings.js?v=95';
import { shareSalePdf } from './sale-pdf-v65.js?v=95';
import { readSharedAnalysisPeriod, resolveAnalysisPeriod, writeSharedAnalysisPeriod } from './analysis-period-v79.js?v=95';
...
const Dashboard = ({ user, userProfile, onLogout }) => {
    ...
    return React.createElement('div', { className: "app-shell" },
            ...
            React.createElement('main', { className: "app-content" },
                loadingData
                    ...
                    : view === 'dashboard' ? React.createElement(AbaVisaoGeral, {
                        ...
                        dashboardTotals, setInstallmentListModal
                    })
        ...
        React.createElement('nav', { className: "mobile-quick-nav", 'aria-label': "Acessos rápidos" },
            mobilePrimaryNav.slice(0, 3).map(item => React.createElement('button', {
                key: item.id,
                type: "button",
                onClick: () => { setView(item.id); setMobileMoreOpen(false); },
            ...
            mobilePrimaryNav.slice(3).map(item => React.createElement('button', {
                key: item.id,
                type: "button",
                onClick: () => { setView(item.id); setMobileMoreOpen(false); },
                className: `mobile-quick-nav-button ${view === item.id ? 'is-active' : ''}`
