...
export const applyFinalPatches = source => {
  ...
  const fixedPaths = {
    ...
    'nova-venda': './nova-venda-fixed-v69.js',
  ...
  const freshModules = new Set([
    ...
    'aba-produtos','aba-produtos-v67','aba-clientes','aba-financeiro-v68','stock-movement-modal-v52','stock-movement-modal-v68',
    'batch-stock-modal-v68','purchase-payment-v68','aba-relatorios-v65','reports-engine-v65','sale-pdf-v65','aba-taxas','payment-settings','utils',
    'inventory-reliability-v69'
  ]);
  ...
  source = source.replace(/(['"])(\.\/[^'"]+?\.js)(?:\?[^'"]*)?\1/g, (match, quote, modulePath) => {
    ...
    if (freshModules.has(moduleName) || /v(52|54|59|60|65|66|67|68|69)/.test(resolved)) url.search = '?v=69';
    return `'${url.href}'`;
  });
