import { applySetupPatches } from './app-patch-setup-v52.js?v=54';
import { applyStockPatch } from './app-patch-stock-v52.js?v=54';
import { applyCancelPatch } from './app-patch-cancel-v52.js?v=54';
import { applyFinalPatches } from './app-patch-final-v52.js?v=54';
...
const criticalModules = [
  ['Financeiro', './aba-financeiro-v54.js?v=54', 'AbaFinanceiro'],
  ['Movimentação de estoque', './stock-movement-modal-v52.js?v=54', 'StockMovementModal'],
  ['Cancelamento de venda', './sale-cancellation-modal-v52.js?v=54', 'SaleCancellationModal'],
  ['Vendas no caixa', './aba-vendas-caixa-v52.js?v=54', 'AbaVendasCaixa'],
  ['Vendas a prazo', './aba-vendas-prazo-v52.js?v=54', 'AbaVendasPrazo'],
  ['Clientes', './aba-clientes-fixed-v52.js?v=54', 'AbaClientes'],
  ['Modais', './modals-fixed-v52.js?v=54', 'SaleDetailsModal'],
  ['Nova venda', './nova-venda-fixed-v52.js?v=54', 'NewSaleScreen']
];
...
export const startApp = async () => {
  const cleanupKey = 'registro-vendas-cleanup-v54';
  ...
  try {
    ...
    await withStage('Falha ao restaurar a última aba', async () => import('./tab-persistence.js?v=54'));
  } finally {
