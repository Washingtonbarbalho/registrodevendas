import { applySetupPatches } from './app-patch-setup-v59.js?v=65';
import { applyReportsPatch } from './app-patch-reports-v65.js?v=65';
import { applyStockPatch } from './app-patch-stock-v52.js?v=65';
import { applyCancelPatch } from './app-patch-cancel-v59.js?v=65';
import { applyProfitPatch } from './app-patch-profit-v58.js?v=65';
import { applySalePdfPatch } from './app-patch-sale-pdf-v65.js?v=65';
import { applyFinalPatches } from './app-patch-final-v65.js?v=65';
...
const criticalModules = [
  ['Financeiro', './aba-financeiro-v54.js?v=65', 'AbaFinanceiro'],
  ['Relatórios', './aba-relatorios-v65.js?v=65', 'AbaRelatorios'],
  ['Movimentação de estoque', './stock-movement-modal-v52.js?v=65', 'StockMovementModal'],
  ['Vendas no caixa', './aba-vendas-caixa-v52.js?v=65', 'AbaVendasCaixa'],
  ['Vendas a prazo', './aba-vendas-prazo-v52.js?v=65', 'AbaVendasPrazo'],
  ['Clientes', './aba-clientes-fixed-v52.js?v=65', 'AbaClientes'],
  ['Modais', './modals-fixed-v65.js?v=65', 'SaleDetailsModal'],
  ['Nova venda', './nova-venda-fixed-v65.js?v=65', 'NewSaleScreen']
];
...
export const startApp = async () => {
  const cleanupKey = 'registro-vendas-cleanup-v65';
  ...
  try {
    ...
    await withStage('Falha ao restaurar a última aba', async () => import('./tab-persistence.js?v=65'));
  } finally {
