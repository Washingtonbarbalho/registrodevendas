...
export const AbaProdutos = ({ productSearch, setProductSearch, paginatedProducts, sortedProducts, productsPage, setProductsPage, setProductDetailsData, setProductModalData, onBatchMovement, ITEMS_PER_PAGE }) => {
    return React.createElement('section', { className: "page-stack animate-fade-in" },
        React.createElement('div', { className: "page-heading" },
            ...
            React.createElement('div', { className: "product-heading-actions" },
                onBatchMovement && React.createElement('button', {
                    type: 'button',
                    onClick: onBatchMovement,
                    className: "batch-stock-trigger"
                }, React.createElement(Boxes, { size: 18 }), "Movimentar em lote"),
