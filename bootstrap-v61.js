import { applySetupPatches } from './app-patch-setup-v59.js?v=61';
import { applyStockPatch } from './app-patch-stock-v52.js?v=61';
import { applyCancelPatch } from './app-patch-cancel-v59.js?v=61';
import { applyProfitPatch } from './app-patch-profit-v58.js?v=61';
import { applyFinalPatches } from './app-patch-final-v61.js?v=61';
...
const criticalModules = [
  ['Financeiro', './aba-financeiro-v54.js?v=61', 'AbaFinanceiro'],
  ['Movimentação de estoque', './stock-movement-modal-v52.js?v=61', 'StockMovementModal'],
  ['Vendas no caixa', './aba-vendas-caixa-v52.js?v=61', 'AbaVendasCaixa'],
  ['Vendas a prazo', './aba-vendas-prazo-v52.js?v=61', 'AbaVendasPrazo'],
  ['Clientes', './aba-clientes-fixed-v52.js?v=61', 'AbaClientes'],
  ['Modais', './modals-fixed-v59.js?v=61', 'SaleDetailsModal'],
  ['Nova venda', './nova-venda-fixed-v60.js?v=61', 'NewSaleScreen']
];
...
export const startApp = async () => {
  const cleanupKey = 'registro-vendas-cleanup-v61';
  ...
  try {
    ...
    await withStage('Falha ao restaurar a última aba', async () => import('./tab-persistence.js?v=61'));
  } finally {
