...
import { DateRangeFilter, DateRangePicker } from './components.js?v=87';
import {
  buildReport,
  PAYMENT_FILTERS,
  REPORT_DEFINITIONS,
  ...
  reportPeriodLabel,
  SALE_CHANNELS
} from './reports-engine-v73.js?v=87';
import { createReportCsvFile, createReportExcelFile, downloadFile, shareFile } from './report-export-v74.js?v=87';
import { buildRepurchaseSuggestions, buildWhatsappUrl } from './commercial-engine-v74.js?v=87';
import { buildExecutiveInsights } from './executive-insights-v79.js?v=87';
import { getReportCategories, getReportFilterCapabilities } from './report-filters-v79.js?v=87';
import { resolveAnalysisPeriod } from './analysis-period-v79.js?v=87';
