...
import { doc, onSnapshot } from './firestore-runtime-v94.js?v=94';
import { formatCurrency, getBrazilDateString, getCurrentMonthEnd, getCurrentMonthStart } from './utils.js';
import { DateRangeFilter, DateRangePicker } from './components.js?v=94';
import {
  buildReport,
  PAYMENT_FILTERS,
  REPORT_DEFINITIONS,
  ...
  reportPeriodLabel,
  SALE_CHANNELS
} from './reports-engine-v73.js?v=94';
import { createReportCsvFile, createReportExcelFile, downloadFile, shareFile } from './report-export-v74.js?v=94';
import { buildRepurchaseSuggestions, buildWhatsappUrl } from './commercial-engine-v74.js?v=94';
import { buildExecutiveInsights } from './executive-insights-v79.js?v=94';
import { getReportCategories, getReportFilterCapabilities } from './report-filters-v79.js?v=94';
import { resolveAnalysisPeriod } from './analysis-period-v79.js?v=94';
import { showAppDateRange } from './ui-interactions-v81.js?v=94';
