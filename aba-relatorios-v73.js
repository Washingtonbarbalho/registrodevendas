...
import { DateRangeFilter, DateRangePicker } from './components.js?v=84';
import {
  buildReport,
  PAYMENT_FILTERS,
  REPORT_DEFINITIONS,
...
import { createReportCsvFile, createReportExcelFile, downloadFile, shareFile } from './report-export-v74.js?v=84';
import { buildRepurchaseSuggestions, buildWhatsappUrl } from './commercial-engine-v74.js?v=84';
import { buildExecutiveInsights } from './executive-insights-v79.js?v=84';
import { getReportCategories, getReportFilterCapabilities } from './report-filters-v79.js?v=84';
import { resolveAnalysisPeriod } from './analysis-period-v79.js?v=84';
import { showAppDateRange } from './ui-interactions-v81.js?v=84';
