import { applySetupPatches } from './app-patch-setup-v59.js?v=63';
import { applyReportsPatch } from './app-patch-reports-v62.js?v=63';
import { applyStockPatch } from './app-patch-stock-v52.js?v=63';
import { applyCancelPatch } from './app-patch-cancel-v59.js?v=63';
import { applyProfitPatch } from './app-patch-profit-v58.js?v=63';
import { applyFinalPatches } from './app-patch-final-v63.js?v=63';
...
const criticalModules = [
  ['Financeiro', './aba-financeiro-v54.js?v=63', 'AbaFinanceiro'],
  ['Relatórios', './aba-relatorios-v63.js?v=63', 'AbaRelatorios'],
  ['Movimentação de estoque', './stock-movement-modal-v52.js?v=63', 'StockMovementModal'],
  ['Vendas no caixa', './aba-vendas-caixa-v52.js?v=63', 'AbaVendasCaixa'],
  ['Vendas a prazo', './aba-vendas-prazo-v52.js?v=63', 'AbaVendasPrazo'],
  ['Clientes', './aba-clientes-fixed-v52.js?v=63', 'AbaClientes'],
  ['Modais', './modals-fixed-v59.js?v=63', 'SaleDetailsModal'],
  ['Nova venda', './nova-venda-fixed-v60.js?v=63', 'NewSaleScreen']
];
...
export const startApp = async () => {
  const cleanupKey = 'registro-vendas-cleanup-v63';
  ...
  try {
    ...
    await withStage('Falha ao restaurar a última aba', async () => import('./tab-persistence.js?v=63'));
  } finally {
